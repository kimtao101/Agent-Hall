...
class XiaohongshuService {
    ...
    async generateCopy(request) {
        try {
            ...
            logger_1.default.error('Error generating Xiaohongshu copy', { error });
            throw error;
        }
    }
    /**
     ...
     * @returns 提示词
     */
    getPromptForScene(scene, config) {
        switch (scene) {
            case 'beauty':
...
// 导出单例实例
exports.xiaohongshuService = new XiaohongshuService();
